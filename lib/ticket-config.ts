...
export const DEFAULT_TICKET_CATEGORIES: TicketConfigItem[] = [
  ...
  },
  {
    ...
    sort_order: 60,
    is_active: true,
    form_template: "ticket_su_ordine",
  },
  {
    id: "default-replenishment",
    code: "rifornimenti_magazzino",
    label: "Rifornimenti Magazzino",
    sort_order: 85,
    is_active: true,
    form_template: "ticket_rifornimento_magazzino",
  },
];
